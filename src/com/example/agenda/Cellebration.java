...
public class Cellebration extends Activity {
	//
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		caltype_ = b.getStringExtra("clatype");
		//
		addItem();
		call();
		add_items();
	...
	protected void submitData() {
		...
		try {
			db.open_celle();
			num = db.addcelle_info(ti, cat, sdate, stime, stime_class, edate,
		...
		if (num > 0) {
			Toast.makeText(this,getResources().getString(R.string.celle_event_added) , 2000).show();
			title_edit.setText("");
	...
	private void updateData() {
		...
		try {
			db.open_celle();
			db.updateRow_cele(ti, cat, sdate, stime, stime_class, edate,
	...
	private void addItem() {
		...
		li = getResources().getStringArray(R.array.cele_categroy);
