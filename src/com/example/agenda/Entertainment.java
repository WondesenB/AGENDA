...
public class Entertainment extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		place_=b.getStringExtra("s_place");
	...
	private void add_items() {
		// TODO Auto-generated method stub
		add_btn = (Button) findViewById(R.id.entmnt_add_button);
		title_edit = (EditText) findViewById(R.id.entmnt_edit_title);
		startdate_edit = (EditText) findViewById(R.id.entmnt_edit_startdate);
		starttime_edit = (EditText) findViewById(R.id.entmnt_edit_starttime);
		endedate_edit = (EditText) findViewById(R.id.entmnt_edit_enddate);
		endetime_edit = (EditText) findViewById(R.id.entmnt_edit_endtime);
		place_edit = (EditText) findViewById(R.id.entmnt_edit_place);
		note_edit = (EditText) findViewById(R.id.entmnt_edit_note);
		cat_spin = (Spinner) findViewById(R.id.entmnt_cat_spin);
		fre_spin = (Spinner) findViewById(R.id.entmnt_fre_spin);
		caltype_spin=(Spinner)findViewById(R.id.entmnt_caleType_spin);
		Timr1_spin = (Spinner) findViewById(R.id.entmnt_Timr1_spin);
		Timr2_spin = (Spinner) findViewById(R.id.entmnt_Time2_spin);
		if (num == 2) {
	...
	protected void submitData() {
		...
		try {
			db.open_entr();
			num = db.addenter_info(ti, cat, sdate, stime, stime_class, edate,
					etime, etime_class, place, fr, note,caltype);
			db.close_entr();
		...
		if (num > 0) {
			Toast.makeText(this,getResources().getString(R.string.enter_event_added) , 2000).show();
			title_edit.setText("");
	...
	private void updateData() {
		...
		try {
			db.open_entr();
			db.updateRow_enter(ti, cat, sdate, stime, stime_class, edate,
					etime, etime_class,place, fr, note,caltype, tit_, categ_, sDate_, sTime_, sTclass_,
					eDate_, eTime_, eTclass_,place_, freq_, nott_);
			db.close_entr();
		} catch (SQLException e) {
			num = -5;
		} finally {
	...
	private void addItem() {
		// TODO Auto-generated method stub
		li = getResources().getStringArray(R.array.enter_categroy);
		...
		sp1 = (Spinner) findViewById(R.id.entmnt_cat_spin);
		sp2 = (Spinner) findViewById(R.id.entmnt_Timr1_spin);
		sp3 = (Spinner) findViewById(R.id.entmnt_Time2_spin);
		sp4 = (Spinner) findViewById(R.id.entmnt_fre_spin);
	}
}
