...
public class Travel extends Activity {
	...
	private EditText splace_edit;
	private EditText desplace_edit;
	...
	private String splace_;
	private String dplace_;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		splace_=b.getStringExtra("s_place");
		dplace_=b.getStringExtra("des_place");
	...
	private void add_items() {
		// TODO Auto-generated method stub
		add_btn = (Button) findViewById(R.id.travel_add_button);
		title_edit = (EditText) findViewById(R.id.travel_edit_title);
		startdate_edit = (EditText) findViewById(R.id.travel_edit_startdate);
		starttime_edit = (EditText) findViewById(R.id.travel_edit_starttime);
		endedate_edit = (EditText) findViewById(R.id.travel_edit_enddate);
		endetime_edit = (EditText) findViewById(R.id.travel_edit_endtime);
		splace_edit = (EditText) findViewById(R.id.travel_edit_splace);
		desplace_edit = (EditText) findViewById(R.id.travel_edit_dplace);
		note_edit = (EditText) findViewById(R.id.travel_edit_note);
		cat_spin = (Spinner) findViewById(R.id.travel_cat_spin);
		fre_spin = (Spinner) findViewById(R.id.travel_fre_spin);
		Timr1_spin = (Spinner) findViewById(R.id.travel_Timr1_spin);
		Timr2_spin = (Spinner) findViewById(R.id.travel_Time2_spin);
		if (num == 2) {
			...
			splace_edit.setText(splace_);
			desplace_edit.setText(dplace_);
	...
	protected void submitData() {
		...
		String splace = splace_edit.getText().toString();
		String dplace = desplace_edit.getText().toString();
		...
		try {
			db.open_travel();
			num = db.addtravel_info(ti, cat, sdate, stime, stime_class, edate,
					etime, etime_class, splace, dplace, fr, note,caltype);
			db.close_travel();
		...
		if (num > 0) {
			Toast.makeText(this,getResources().getString(R.string.travel_event_added) , 2000).show();
			title_edit.setText("");
	...
	private void updateData() {
		...
		try {
			db.open_travel();
			db.updateRow_travel(ti, cat, sdate, stime, stime_class, edate,
					etime, etime_class,splace,dplace, fr, note,caltype, tit_, categ_, sDate_, sTime_, sTclass_,
					eDate_, eTime_, eTclass_,splace_,dplace_, freq_, nott_);
			db.close_travel();
		} catch (SQLException e) {
			num = -5;
		} finally {
	...
	private void call() {
		...
		sp1.setAdapter(adp);
		caltype_spin = (Spinner) findViewById(R.id.travel_caleType_spin);
		sp2.setAdapter(adp3);
		sp3.setAdapter(adp3);
	...
	private void addItem() {
		// TODO Auto-generated method stub
		li = getResources().getStringArray(R.array.travel_categroy);
		...
		sp1 = (Spinner) findViewById(R.id.travel_cat_spin);
		sp2 = (Spinner) findViewById(R.id.travel_Timr1_spin);
		sp3 = (Spinner) findViewById(R.id.travel_Time2_spin);
		sp4 = (Spinner) findViewById(R.id.travel_fre_spin);
	}
}
