...
public class Education extends Activity {
	...
	protected void submitData() {
		...
		try {
			db.open_edu();
			num = db.addedu_info(ti, cat, sdate, stime, stime_class, edate,
		...
		if (num > 0) {
			Toast.makeText(this, getResources().getString(R.string.edu_event_added) , 2000).show();
			title_edit.setText("");
	...
	private void updateData() {
		...
		try {
			db.open_edu();
			db.updateRow_edu(ti, cat, sdate, stime, stime_class, edate,
	...
	private void addItem() {
		// TODO Auto-generated method stub
		li = getResources().getStringArray(R.array.edu_categroy);
