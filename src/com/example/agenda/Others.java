...
public class Others extends Activity {
	...
	private void addItem() {
		// TODO Auto-generated method stub
		li = getResources().getStringArray(R.array.other_categroy);
	...
	protected void submitData() {
		...
		try {
			db.open_others();
			num = db.addothers_info(ti, cat, sdate, stime, stime_class, edate,
		...
		if (num > 0) {
			Toast.makeText(this, getResources().getString(R.string.others_event_added) , 2000).show();
			title_edit.setText("");
	...
	private void updateData() {
		...
		try {
			db.open_others();
			db.updateRow_other(ti, cat, sdate, stime, stime_class, edate,
